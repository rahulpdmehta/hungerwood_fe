            ...
            >
              ...
              <div className="relative w-32 h-32 mx-auto mb-4">
                ...
                <motion.div
                  ...
                  className="absolute top-0 left-1/2 transform -translate-x-1/2 w-24 h-8 bg-gradient-to-br from-[#7f4f13] to-[#f8b84e] rounded-t-lg border-4 border-[#7f4f13]"
                ...
                <motion.div
                  ...
                  className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-24 h-24 bg-gradient-to-br from-[#7f4f13] to-[#f8b84e] rounded-lg border-4 border-[#7f4f13] flex items-center justify-center"
                >
                ...
                {giftOpened && (
                  ...
                  >
                    ...
                    <div className="bg-[#f8f7f6] dark:bg-[#211811] rounded-lg p-3">
                      ...
                      <p className="text-xl font-bold text-[#7f4f13]">
                        +₹{reward?.amount || 0}
                      </p>
                    </div>
                  </motion.div>
