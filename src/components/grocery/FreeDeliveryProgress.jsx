...
export default function FreeDeliveryProgress({ subtotal, threshold }) {
  ...
  if (subtotal >= threshold) {
    return (
      <div className="bg-green-50 text-green-800 px-3 py-2 rounded-lg mb-3 text-2xs font-bold flex items-center gap-2">
  ...
  return (
    <div className="bg-green-50 px-3 py-2 rounded-lg mb-3 text-2xs text-gray-800">
