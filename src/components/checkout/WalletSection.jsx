        ...
        return (
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-[#2d221a] dark:to-[#3d2e24] rounded-2xl p-5 shadow-sm border border-gray-200 dark:border-[#3d2e24] mb-6 opacity-60">
                <div className="flex items-center gap-4">
                    ...
                    {/* Add Money Button */}
                    <button className="px-4 py-2 bg-[#7f4f13]/20 text-[#7f4f13] rounded-lg text-sm font-semibold hover:bg-[#7f4f13]/30 transition-colors">
                        Add Money
                    </button>
                </div>
            </div>
                        ...
                        <div className="pt-4 border-t border-[#f4f2f0] dark:border-[#3d2e24]">
                            ...
                            <div className="flex items-center justify-center gap-4 mb-4">
                                ...
                                <button
                                    ...
                                    className="w-12 h-12 rounded-xl bg-[#7f4f13]/10 text-[#7f4f13] font-bold text-xl flex items-center justify-center disabled:opacity-40 disabled:cursor-not-allowed hover:bg-[#7f4f13]/20 active:scale-95 transition-all shadow-sm"
                                ...
                                <div className="flex-1 max-w-[140px]">
                                    <div className="bg-white dark:bg-[#211811] rounded-xl p-2 text-center border-2 border-green-400 dark:border-green-600 shadow-inner">
                                        <div className="text-md font-bold text-[#7f4f13] tracking-tight">
                                            ₹{walletAmount}
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="mt-4 bg-gradient-to-br from-[#fef9f5] to-white dark:from-[#211811] dark:to-[#2d221a] rounded-2xl p-5 shadow-sm border border-[#f4f2f0] dark:border-[#3d2e24]">
                    ...
                    <div className="space-y-2.5 mb-4">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <span className="text-[#887263] dark:text-gray-400">Order Total</span>
                            <span className="text-[#181411] dark:text-white font-medium">₹{orderTotal}</span>
                        </div>
                    ...
                    <div className="border-t-2 border-[#7f4f13]/20 pt-4">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-xs text-[#887263] dark:text-gray-400 uppercase tracking-wider mb-1">
                                    Amount Payable
                                </p>
                                <p className="text-2xl font-bold text-[#7f4f13] tracking-tight">
